...
- ✅ **Нотоносец** - отображать нотный стан (5 линий) вместо текста песни для ручных пометок нот
...
### Нотоносец (новое!)
При включенном чекбоксе "Нотоносец" вместо текста песни отображается нотный стан (5 горизонтальных линий) справа от аккордов. Это позволяет музыкантам делать ручные пометки нот во время звучания аккордов.
...
- **Нотный стан** для ручных пометок нот (5 линий с настраиваемыми параметрами)
