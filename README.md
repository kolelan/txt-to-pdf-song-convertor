...
- **🔊 Воспроизведение в браузере** - прослушивание композиции прямо в приложении
...
- **Воспроизведение в браузере**: прослушивание композиции через Web Audio API
...
- **Поддержка всех аккордов**: автоматическое определение всех мажорных и минорных аккордов (включая диезы и бемоли)
...
По умолчанию все мажорные и минорные аккорды определены в 3-й октаве. Вы можете переопределить любой аккорд в поле "Пользовательские аккорды":
...
Поддерживаются все октавы от C0 до B8 (например: C2, E3, G#4).
